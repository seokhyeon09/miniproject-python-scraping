...
## Links
- 배포 주소: [배포된 서비스 링크를 입력하세요]
- GitHub 저장소: [https://github.com/seokhyeon09/miniproject-python-scraping](https://github.com/seokhyeon09/miniproject-python-scraping)
...
- 문제점: 위시리스트 화면에서 상품 삭제 버튼을 눌렀을 때 **422 Unprocessable Entity** 에러가 발생하는 문제가 있었습니다. 원인을 분석해보니, 홈 화면과 달리 위시리스트 화면에서는 검색어 변수가 없어서 서버에 빈 값이 전달되며 서버의 필수 입력 검증 로직에서 막히는 것이었습니다.
...
git clone [https://github.com/seokhyeon09/miniproject-python-scraping](https://github.com/seokhyeon09/miniproject-python-scraping)

2. 패키지 설치 (Install dependencies)
pip install -r requirements.txt

3. 환경 변수 설정 (Set up environment variables)
최상위 경로에 .env 파일을 생성하고 네이버 API 키 및 MongoDB 연결 주소 등을 입력하세요.
